...
const UploadedTable = ({ docs, setVeiwDetail, totalPages, totalDocs,
   setCurrentPage,
    setLimit,
    currentPage,
   limit,
 ...
 console.log(' this is aa totalPages',totalPages)
 console.log(' this is  a totalDocs',totalDocs)
...
const end = start + docs.length - 1;
 ...
 const handleDelete = async (ID) => {
  ...
  const message = "Are you sure you want to delete this Customer Document?";
