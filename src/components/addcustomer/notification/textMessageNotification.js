...
const TextMessageNotification = ({ name, formik }) => {
  ...
  return (
    <div className="flex flex-col xs:flex-row gap-5 px-3 mt-4">
      <div className="  w-full xs:w-[35%] flex flex-col gap-2 pb-6">
        <h2 className="text-sm font-semibold">Text Message on Number</h2>
