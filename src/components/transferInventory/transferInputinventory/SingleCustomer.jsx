...
const SingleCustomer = ({ label, name, onChange,placeholder, value = null, error }) => {
    ...
    <div className="relative form-row" ref={dropdownRef}>
      ...
      >
        <input
          ...
          className="w-full bg-transparent py-2 h-[32px] px-4 text-base text-primary rounded-lg outline-none cursor-pointer"
        />
