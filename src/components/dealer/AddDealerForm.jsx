...
const AddDealerForm = () => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    const payload = {
      ...
      ...(values.whatsappNumber2 && {
        whatsappNumber2: values.whatsappNumber2,
      }),
      ...(values.houseFlatNumber && {
        houseFlatNumber: values.houseFlatNumber,
      }),
            ...
            <>
              <Form className="flex flex-col gap-6 ">
                <div className="flex justify-between items-center w-full">
                  <h2 className="page-heading">Add New Dealer</h2>
