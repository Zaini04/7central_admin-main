...
const CampaignsCards = () => {
  const cardData = [
    { title: "Campaign", value: "11", percentage: "20%", icon: <Customers />, bgIcon: "bg-[#246BFD]" },
    { title: "Sent", value: "11", percentage: "20%", icon: <InventorySvg />, bgIcon: "bg-[#08B839]" },
    { title: "Opened", value: "11", percentage: "20%", icon: <PaidReceiptSvg />, bgIcon: "bg-[#FD0000]" },
