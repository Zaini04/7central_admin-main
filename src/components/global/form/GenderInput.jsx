...
// static list, edit/add options as needed
...
const GenderInput = ({ name, formik, label = "Gender" }) => {
  ...
  return (
    <div className="relative form-row" ref={dropdownRef}>
      ...
      {showMenu && (
        <div className="absolute top-[60px] left-0 w-full bg-white border border-gray-300 rounded-md shadow-md z-10 overflow-y-auto">
