import {updateItems} from 'constants/addcustomer.constants';
              ...
              return (
                <li key={item.id}>
                  <div
                   ...
                   className={`flex flex-row  rounded-xl justify-center w-full lg:justify-start items-center px-2 py-2 gap-2 text-xs cursor-pointer transition-all group
                      ${
                        isActive
