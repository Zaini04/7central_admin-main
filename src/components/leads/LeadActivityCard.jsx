...
const ActivityCard = ({ item, actionText,markedBy }) => {
  return (
    ...
    <div className="flex flex-col">
      <span className="font-medium text-[#1A1C1E] text-xs">{markedBy || "Unknown"}</span>
      <span className="text-[10px] text-gray-400 font-semibold mt-0.5">Marked by</span>
    </div>
  </div>
