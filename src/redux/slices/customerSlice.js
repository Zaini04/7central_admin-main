...
const customerSlice = createSlice({
 ...
 createCustomerDocumnetLoading:false,
   createCustomerAssignLoading:false,
  createCustomerInventoryDocumnetLoading:false,
    createCustomerInventoryInstallmentLoading:false,
   createCustomerNextOfKinLoading:false,
      createCustomerNotificationLoading:false,
    ...
    deleteCustomerLoading:false,
      customerDocumnet:null,
// 
      customerInstallments:[],
      customerInstallmentsDetail:null,


      // 
      customerReceipts:[],
      customerReceiptsDetail:null,
